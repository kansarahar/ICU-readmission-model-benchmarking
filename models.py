...
class BiRNNConcatTimeDelta(nn.Module):
    # GRU
    def __init__(self, num_static, num_dp_codes, num_cp_codes):
        super(BiRNNConcatTimeDelta, self).__init__()
...
class BiRNNConcatTimeDeltaAttention(nn.Module):
    # GRU
    def __init__(self, num_static, num_dp_codes, num_cp_codes):
        super(BiRNNConcatTimeDeltaAttention, self).__init__()
...
class BiRNNTimeDecay(nn.Module):
    # GRU
    def __init__(self, num_static, num_dp_codes, num_cp_codes):
        super(BiRNNTimeDecay, self).__init__()
...
class BiRNNTimeDecayAttention(nn.Module):
    # GRU
    def __init__(self, num_static, num_dp_codes, num_cp_codes):
        super(BiRNNTimeDecayAttention, self).__init__()
...
class AttentionConcatTime(nn.Module):
    # Attention Only
    def __init__(self, num_static, num_dp_codes, num_cp_codes):
        super(AttentionConcatTime, self).__init__()
...
class ODEBiRNN(nn.Module):
    def __init__(self, num_static, num_dp_codes, num_cp_codes):
        super(ODEBiRNN, self).__init__()
...
class ODEBiRNNAttention(nn.Module):
    def __init__(self, num_static, num_dp_codes, num_cp_codes):
        super(ODEBiRNNAttention, self).__init__()
...
class BiRNNODEDecay(nn.Module):
  class Net(nn.Module):
    def __init__(self, num_static, num_dp_codes, num_cp_codes):
        super(BiRNNODEDecay, self).__init__()
...
class BiRNNODEDecayAttention(nn.Module):
    def __init__(self, num_static, num_dp_codes, num_cp_codes):
        super(BiRNNODEDecayAttention, self).__init__()
...
class MCEAttention(nn.Module):
    def __init__(self, num_static, num_dp_codes, num_cp_codes):
        super(MCEAttention, self).__init__()
